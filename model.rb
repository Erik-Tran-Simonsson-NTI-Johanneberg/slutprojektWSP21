module Model
    ...
    # 
    # @params [Integer] id, The ID of the recipe
    # 
    # @return [Hash]
    ...
    # 
    # @params [String] recipe_name, The name of the recipe
    # @params [Integer] user_id, The ID of the user
    # @params [String] date_created, The date of the recipe creation
    # @params [String] ingredients, The ingredients of the recipe
    # @params [Integer] instructions, The instructions of the recipe
    ...
    # @params [String] recipe_name, The name of the recipe
    # @params [Integer] user_id, The ID of the user
    # @params [String] date_updated, The date of the latest recipe update
    # @params [String] ingredients, The ingredients of the recipe
    # @params [Integer] instructions, The instructions of the recipe
    ...
    # 
    # @params [Integer] recipe_id, The ID of the recipe
    ...
    # 
    # @params [Integer] username, The username of the user
    # 
    # @return [Hash]
    #   * :user_id [Integer] The ID of the user
